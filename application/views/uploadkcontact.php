                        ...
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Upload Data Kcontact</h4>
                                    <form action="douploadkcontact" method="post" enctype="multipart/form-data">
                                        <div class="fileinput fileinput-new text-center col-sm-4 col-sm-offset-4" data-provides="fileinput">
                                            ...
                                            <div>
                                                <span class="btn btn-danger btn-round btn-file">
                                                    ...
                                                    <input type="file" name="datakcontact" required accept=".xls,.xlsx" />
                                                </span>
