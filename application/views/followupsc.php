                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Follow Up SC</h4>
                                    <div class="toolbar">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->isvalidalamat;?></td>
                                                    ...
                                                    <td class="td-actions text-right" width="20%">
                                                        <a href="dofollowupsc/<?php echo $row->scbe_trackid;?>" class="btn btn-success btn-simple">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form method="post" action="filterfusc" class="form-horizontal">
                                        <div class="row">
