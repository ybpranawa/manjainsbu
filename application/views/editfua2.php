            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="<?php echo base_url();?>Myir/doeditfua2" class="form-horizontal">
                                    <?php
                                    ...
                                    <div class="card-header card-header-text" data-background-color="red">
                                        <h4 class="card-title">Edit FU Track ID</h4>
                                    </div>
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" name="trackid" text="<?php  echo $query[0]->fu_trackid;?>" value="<?php  echo $query[0]->scbe_trackid;?>" class="form-control" readonly="readonly" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <input name="cp" id="textinput1" type="text" value="<?php  echo $query[0]->fu_validcp;?>" class="form-control" value required >
                                                    <span id="cek1" class="material-icons form-control-feedback"></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <textarea name="alamat" id="textinput2" class="form-control" required ><?php  echo $query[0]->fu_alamat;?>
                                                    </textarea>
                                                    <!-- <input id="textinput2" type="text" value="<?php  echo $query[0]->fu_alamat;?>" class="form-control" value> -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <input name="acuanalamat" id="textinput" type="text" value="<?php echo $query[0]->fu_acuanalamat; ?>" class="form-control" value required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <input name="sto" id="textinput3" type="text" value="<?php  echo $query[0]->fu_sto;?>" class="form-control" value required >
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="keterangana2" id="dropdown" class="selectpicker" data-style="btn btn-success btn-round" title="Keterangan" data-size="7" >
                                                        ...
                                                        <!-- <option value="VAL022">NOK</option> -->
                                                    </select>
                                                </div>
                                                <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <input name="detilketa2" id="textinput" type="text" class="form-control" value="<?php echo $query[0]->fu_detilketerangan; ?>" required>
                                                    <span id="cek" class="material-icons form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <input name="feedbackagency" id="textinput" type="text" class="form-control" value="<?php echo $query[0]->feed_feedback; ?>" readonly>
                                                    <span id="cek" class="material-icons form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data==0){
                ...
                $("#dobelinput").empty();
                $("#dobelinput").append("<div class='alert alert-danger'><button type='button' aria-hidden='true' class='close'><i class='material-icons'>close</i></button><span><b> Peringatan - </b> Inputan terindikasi double input</span></div>");
