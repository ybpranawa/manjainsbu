                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    if ($row->fusc_scid!=NULL)
                                                    {
                                                    ?>
                                                    <td class="td-actions text-right" width="20%">
                                                        <a href="editfusc/<?php echo $row->scbe_trackid;?>" class="btn btn-success btn-simple">
                                                    ...
                                                    ?>
                                                    <td class="td-actions text-right" width="20%">
                                                        <a href="#" class="btn btn-success btn-simple">
                                                            <i class="material-icons">edit</i>
                                                        </a>
                                                    </td>
                                                    <?php
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form method="post" action="filterrekapscbe" class="form-horizontal">
                                        <div class="row">
