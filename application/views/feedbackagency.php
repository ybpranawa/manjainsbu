                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Data Butuh Feedback Agency</h4>
                                    <div class="toolbar">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right" >
                                                        <a href="dofeedbackagency/<?php echo $row->scbe_trackid;?>" class="btn btn-success btn-simple">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Lihat Semua Data Inputan</h4>
                                    <form method="post" action="filterfeedbackagency" class="form-horizontal">
                                        <div class="row">
