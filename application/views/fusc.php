            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="<?php echo base_url();?>Myir/insertsc" class="form-horizontal">
                                    <?php
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group label-floating is-empty has-success">
                                                    <label class="control-label"></label>
                                                    <input name="scid" id="textinput1" placeholder="Sertakan huruf SC tanpa spasi & tanda hubung. Contoh: SC123456" type="text" value class="form-control" required>
                                                    <span id="cek1" class="material-icons form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
